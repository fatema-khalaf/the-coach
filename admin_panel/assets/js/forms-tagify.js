...
!(function () {
  var a = document.querySelector("#TagifyBasic"),
    ...
    a =
      (new Tagify(a), document.querySelector("#TagifyCustomInlineSuggestion")),
  ...
  i.on("dropdown:show dropdown:updated", function (a) {
    ...
    1 < i.suggestedListItems.length &&
      ((n = i.parseTemplate("dropdownItem", [
        {
          class: "addAll",
          name: "Add all",
          email:
            i.settings.whitelist.reduce(function (a, e) {
